...
import com.jojo.app.MessageType;
import com.jojo.connection.DatabaseConnection;
import com.jojo.model.Model_File;
import com.jojo.model.Model_File_Receiver;
import com.jojo.model.Model_File_Sender;
import com.jojo.model.Model_Package_Sender;
import com.jojo.model.Model_Receive_Image;
import com.jojo.model.Model_Send_Message;
import com.jojo.swing.blurHash.BlurHash;
...
public class ServiceFIle {
    ...
    private final String INSERT = "INSERT INTO dbo.files (FileExtension) VALUES (?)";
    private final String UPDATE_BLUR_HASH_DONE = "UPDATE dbo.files SET BlurHash=?, [Status]='1' WHERE FileID=? OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY";
    private final String UPDATE_DONE = "UPDATE dbo.files SET [Status]='1' WHERE FileID=? OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY";
    private final String GET_FILE_EXTENSION = "SELECT FileExtension FROM dbo.files WHERE FileID=? OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY";
